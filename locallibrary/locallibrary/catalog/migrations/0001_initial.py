    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='13 цифр <a href="https://www.isbn-international.org/content/what-isbn">ISBN номер</a>', max_length=13, verbose_name='ISBN')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Укажите жанр для этой книги', to='catalog.genre'),
        ),
    ]
